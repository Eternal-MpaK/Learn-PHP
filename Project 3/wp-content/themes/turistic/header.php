            ...
            <div class="top-header__wrap">
                ...
                <nav class="main-navigation">
                    <ul class="nav-list">
                        ...
                        <li class="nav-list__nav-item"><a href="/akcii/" class="nav-list__nav-item__nav-link">Последние акции</a></li>
                        <li class="nav-list__nav-item"><a href="/o-servise/" class="nav-list__nav-item__nav-link">О сервисе</a></li>
                        <li class="nav-list__nav-item"><a href="/novosti/" class="nav-list__nav-item__nav-link">Новости</a></li>
                    </ul>
                </nav>
            </div>
        </div>
